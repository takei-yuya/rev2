...
e.g.
echo "foo bar baz" | rev2             # "zab rab oof"
echo "foobarbaz"   | rev2 -n3         # "bazbarfoo"
echo "foo,bar,baz" | rev2 -d,         # "baz,bar,foo"
echo "foo,bar,baz" | rev2 -d, -j' '   # "baz bar foo"
echo "foo,bar+baz" | rev2 -d,+        # "baz,bar,foo"
```
